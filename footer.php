<footer class="footer">
    <div class="wrapper">
        ...
        <div class="footer__box">
            <div class="footer__box__items">
                ...
                foreach ($categories as $category):?>   
                    <a class="footer__box__link" href="/product-category/<?echo $category->slug;?>"><? echo $category->cat_name; ?></a>
                <?php endforeach; wp_reset_postdata();?>
            </div>
            <div class="footer__box__items">
                <h5>Фабрика</h5>  
                <a class="footer__box__link" href="<?php echo get_page_link(66)?>">О Компании</a>
                <a class="footer__box__link" href="<?php echo get_page_link(81)?>">Работа с нами</a>
                <a class="footer__box__link" href="<?php echo get_page_link(100)?>">Акционерам</a>
                <a class="footer__box__link" href="<?php echo get_page_link(118)?>">Руководство</a>
                <a class="footer__box__link" href="<?php echo get_page_link(130)?>">Контакты</a>
                <a class="footer__box__link" href="<?php echo get_page_link(218)?>">Социальная сфера</a>
                <a class="footer__box__link" href="<?php echo get_page_link(199)?>">Медиа и новости</a>
                <a class="footer__box__link" href="<?php echo get_page_link(211)?>">Мы и общество</a>
            </div>
            <div class="footer__box__items">
                <h5>Медиа и новости</h5>    
                <?$categories = get_categories( [
                    'taxonomy'     => 'product_cat',
                    'parent' => 0,
                    'hide_empty' => 0,
            ...
            <div class="footer__box__items footer__box__items--center scrollto">
                <a class="btn-top" href="#hero">
                    <svg class="btn-top__icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16px" height="32px">
                        <image  x="0px" y="0px" width="16px" height="32px"  xlink:href="data:img/png;base64," />
                    </svg>
                </a>
            </div>
        </div>
        <div class="footer__bottom">
            <?if( have_rows('bannery', 275) ):
                while ( have_rows('bannery', 275) ) : the_row();?>
                    <div class="footer__bottom__items">
                        <a class="footer__bottom__link" target="_blank" href="<? the_sub_field('link_banner_footer', 275); ?>">
                            <img class="footer__bottom__img" src="<? the_sub_field('img_banner_footer', 275); ?>" alt="">
                        </a>
                    </div>
                <? endwhile;
            endif;?>
        ...
        <div class="footer__copy">
            <a class="footer__copy__link" href="<?php echo get_page_link(3)?>">Политики конфиденциальности</a>
        </div>
    </div>
</footer>
<?php wp_footer(); ?>
